            ...
            for i in range(0, num_rows):
                ...
                if i in kwargs["harmonic_position"]:
                    for q in range(0, kwargs["num_harmonics"]*num_cols):
                        ...
                        loc=(i*((kwargs["plot_height"]*kwargs["num_harmonics"])+kwargs["row_spacing"])+(kwargs["plot_height"]*(q%kwargs["num_harmonics"])),int(np.floor(q/kwargs["num_harmonics"]))*(kwargs["plot_width"]+kwargs["col_spacing"]))
                        """
                    ...
                    for q in range(0, 2*num_cols):
                        if q%2==0:
                            rowspan=kwargs["plot_height"]
                            colspan=kwargs["plot_width"]
                            loc=(i*(kwargs["num_harmonics"]+kwargs["row_spacing"]),int(np.floor(q/2))*(kwargs["plot_width"]+kwargs["col_spacing"]))
                            subplotspec=gridspecification.new_subplotspec(loc, rowspan, colspan)
                            ax=plt.subplot(subplotspec)
                            row_axes.append(ax)
                        else:
                            rowspan=kwargs["plot_height"]*(kwargs["num_harmonics"]-1)
                            colspan=kwargs["plot_width"]
                            loc=(i*(kwargs["num_harmonics"]+kwargs["row_spacing"])+(q%2),int(np.floor(q/2))*(kwargs["plot_width"]+kwargs["col_spacing"]))
                            subplotspec=gridspecification.new_subplotspec(loc, rowspan, colspan)
                            ax=plt.subplot(subplotspec)
                            row_axes.append(ax)
                    ...
                    for q in range(0, 2*num_cols):
                        loc=(i*(kwargs["num_harmonics"]+kwargs["row_spacing"])+((q%2)*(f_val)),int(np.floor(q/2))*(kwargs["plot_width"]+kwargs["col_spacing"]))
                    ...
                    for j in range(0, num_cols):
                        loc=(i*((kwargs["plot_height"]*kwargs["num_harmonics"])+kwargs["row_spacing"]),j*(kwargs["plot_width"]+kwargs["col_spacing"]))
                ...
                if i in kwargs["harmonic_position"]:
                    for j in range(0, num_rows):
                        for q in range(0, kwargs["num_harmonics"]):
                            loc=(j*((kwargs["num_harmonics"]*kwargs["plot_height"])+kwargs["row_spacing"])+(q*kwargs["plot_height"]),i*(kwargs["plot_width"]+kwargs["col_spacing"]))
                            rowspan=kwargs["plot_height"]
                            colspan=kwargs["plot_width"]
                            subplotspec=gridspecification.new_subplotspec(loc, rowspan, colspan)
                            ax=plt.subplot(subplotspec)
                    ...
                    for j in range(0, num_rows):
                        for q in range(0, 2):
                            loc=((j*(kwargs["num_harmonics"]+kwargs["row_spacing"])+(q*f_val)),i*(kwargs["plot_width"]+kwargs["col_spacing"]))
                            rowspan=int(np.floor(kwargs["num_harmonics"]/2))
                            colspan=kwargs["plot_width"]
                            subplotspec=gridspecification.new_subplotspec(loc, rowspan, colspan)
                            ax=plt.subplot(subplotspec)
