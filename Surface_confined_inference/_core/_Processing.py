...
def top_hat_filter(times, time_series, **kwargs):
    ...
    if kwargs["return_type"]== "abs":
        return abs(results)
    elif kwargs["return_type"]== "imag":
        return np.imag(results)
    elif kwargs["return_type"]== "real":
        return np.real(results)
    elif kwargs["return_type"]== "composite":
        comp_results = np.append(np.real(results), np.imag(results))
        return comp_results
    elif kwargs["return_type"]== "inverse":
