...
class FourierGaussianLogLikelihood(pints.ProblemLogLikelihood):
    def __init__(self, problem, ):
        ...
        self.filter_kwargs={
            "Fourier_window":problem._internal_options.Fourier_window,
            "top_hat_width":problem._internal_options.top_hat_width, 
            "Fourier_function":problem._internal_options.Fourier_function,
            "Fourier_harmonics":problem._internal_options.Fourier_harmonics,
        }
